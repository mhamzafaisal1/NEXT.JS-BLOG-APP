...
const PostCard = ({ post }) => {
  return (
    <div className='bg-white shadow-lg rounded-lg p-0 lg:p-8 pb-12 mb-8'>
      ...
      <div className='block lg:flex text text-center items-center justify-center mb-8 w-full '>
        <div className='flex items-center justify-center mb-4 lg:w-auto'>
          <img
          ...
          />
          <p className='inline align-middle text-gray-700 ml-2 font-medium text-lg'> </p>
        </div>
